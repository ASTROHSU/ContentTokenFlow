...
export function WalletSelector() {
  ...
  const { wallet, connectMetaMask, connectWalletConnect, disconnectWallet } = useWalletConnect();
              ...
              <CardContent className="p-4 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium capitalize">
                    {wallet.walletType === 'metamask' ? 'MetaMask' : 'WalletConnect'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
            ...
            >
              <CardContent className="p-4 flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">使用 MetaMask 瀏覽器擴展</p>
                </div>
              </CardContent>
            </Card>
